...
STATE_DIR="$TEST_STATE_DIR"; CONFIG_DIR="$TEST_CONFIG_DIR"; CONTROL_DIR="$TEST_CONTROL_DIR"; TLS_DIR="$TEST_TLS_DIR"; CF_TXN_STATE="$TEST_CF_TXN_STATE"; CF_TXN_BACKUP_DIR="$TEST_CONTROL_DIR/cloudflare-transaction-backup"; MANAGEMENT_LOCK="$TEST_CONTROL_DIR/management.lock"; MANAGEMENT_LOCK_FD=""
